<template>
  <div>
          ...
          <div class="flex items-start -mx-4">
            ...
            <div class="px-4">
              <span class="font-semibold text-custom-black text-xl"
                >{{$t('Classroom.Create.locked')}}</span
              >
    ...
    <div class="section bg-white text-center">
      <h1 class="font-extrabold text-4xl mb-8">{{$t('Classroom.Service.service')}}</h1>
      <div class="vx-row mt-8 sm:-mx-6">
        ...
        >
          <vx-card style="height: 100%">
            ...
            <div class="text-center">
              <h5 class="mb-2 font-semibold text-xl mb-8">{{$t('Classroom.Service.browser.title')}}</h5>
              <p>
        ...
        >
          <vx-card style="height: 100%">
            ...
            <div class="text-center">
              <h5 class="mb-2 font-semibold text-xl mb-8">{{$t('Classroom.Service.not.title')}}</h5>
              <p>
    ...
    <div class="section bg-white">
      <div class="text-center mb-20">
        <h1 class="font-extrabold text-4xl mb-4">{{$t('Classroom.FQ.title')}}</h1>
        <div class="text-left">
          <vs-collapse accordion type="margin" ref="vsCollapse">
            ...
            >
              ...
              <div class="p-8">
                ...
                <ol class="ml-4">
                  <li class="mb-base">
                    <b>{{$t('Classroom.FQ.1.ans.point1_h')}} :</b> {{$t('Classroom.FQ.1.ans.point1_p')}}
                  </li>
                  <li class="mb-base">
                    <b>{{$t('Classroom.FQ.1.ans.point2_h')}} :</b> {{$t('Classroom.FQ.1.ans.point2_p')}}
                  </li>
                  <li>
                    <b>{{$t('Classroom.FQ.1.ans.point3_h')}} :</b> {{$t('Classroom.FQ.1.ans.point3_p')}}
                  </li>
                </ol>
              </div>
            </vs-collapse-item>
            ...
            >
              ...
              <div class="p-8">
                ...
                <ol class="ml-4">
                  <li>
                    <b>{{$t('Classroom.FQ.2.ans.point1_h')}} :</b> {{$t('Classroom.FQ.2.ans.point1_p')}}
                  </li>
                </ol>
              </div>
            </vs-collapse-item>
            ...
            >
              ...
              <div class="p-8">
                <p class="mb-base">
                  <i
                    ><b
                      >{{$t('Classroom.FQ.4.ans.quote')}}</b
                    >
                    -{{$t('Classroom.FQ.4.ans.writer')}}</i
                  >
                </p>
                <p class="mb-6">
            ...
            >
              ...
              <div class="p-8">
                <p class="mb-base">{{$t('Classroom.FQ.5.ans.short')}} <b>{{$t('Classroom.FQ.5.ans.no')}}</b></p>
                <p class="mb-base">
                  {{$t('Classroom.FQ.5.ans.para1')}}
                </p>
                <p class="mb-base">
                  {{$t('Classroom.FQ.5.ans.so')}} <b>{{$t('Classroom.FQ.5.ans.can')}}</b>
                </p>
                <p>
                  <b>{{$t('Classroom.FQ.5.ans.yes')}}</b> {{$t('Classroom.FQ.5.ans.para2')}}
                </p>
              </div>
            </vs-collapse-item>
...
export default {
  ...
  computed: {
    ...
    getClassroomLink() {
      return `https://class.video.wiki/b/start_class?name=${this.userInfo.first_name}&email=${this.userInfo.email}`; // &room_name=${this.classroomName}`;
    },
    userInfo() {
